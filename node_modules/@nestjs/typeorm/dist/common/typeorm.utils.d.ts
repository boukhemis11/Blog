...
export declare function getRepositoryToken(entity: Function, connection?: Connection | ConnectionOptions | string): string;
...
export declare function handleRetry(retryAttempts?: number, retryDelay?: number, connectionName?: string): <T>(source: Observable<T>) => Observable<T>;
